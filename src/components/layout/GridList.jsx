  ...
  return (
    <div className={`p-6 max-w-7xl mx-auto ${className}`}>
      <div className="text-center mb-10">
        <h2 className="flex flex-wrap justify-center items-center gap-2 text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-3">
          <span>Search by</span>
          <RotatingText
            texts={["Doctors", "Hospitals", "Services"]}
            mainClassName="px-2 sm:px-2 md:px-3 bg-green-200 text-black overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
            staggerFrom={"last"}
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
            exit={{ y: "-120%" }}
